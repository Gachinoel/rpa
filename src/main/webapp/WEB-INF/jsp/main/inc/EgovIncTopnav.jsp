...
<ul>
	<!-- 
	<li><a href="#LINK" onclick="javascript:fn_main_headPageMove('11','main/sample_menu/EgovAboutSite')" >구매관리</a></li>
	<li><a href="#LINK" onclick="javascript:fn_main_headPageMove('21','main/sample_menu/EgovProductInfo')" >구매관리</a></li>
    	
    
    <li><a href="#LINK" onclick="javascript:fn_main_headPageMove('31','main/sample_menu/EgovDownload')" >고객지원</a></li>
    <li><a href="#LINK" onclick="javascript:fn_main_headPageAction('31','cop/smt/sim/EgovIndvdlSchdulManageWeekList.do')" >구매관리</a></li>
    -->
    ...
    %>
	    ...
	    <li><a href="#LINK" onclick="javascript:fn_main_headPageMove('51','main/EgovMainView')" >구매관리</a></li>
