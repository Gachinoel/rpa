...
<script type="text/javascript">
	...
	function fn_egov_select_brdMstr2(){
			...
			document.frm.action = "<c:url value='/cop/bbs/selectExtraSPFinishList.do'/>";
			document.frm.submit();
	...
	function fn_egov_excel_download(num){
		...
		document.frm.action = "<c:url value='/cop/bbs/selectExtraSPExcel1.do'/>";
    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <!-- 검색 필드 박스 시작 -->
                <div id="search_field"> 
                    <div id="search_field_loc"><h2><strong>수입부대비용 마감 정보</strong></h2></div>
                ...
                <div class="default_tablestyle" style="color:black">
                    ...
                    <div id="search_field_loc"><h2><strong>수입 부대비용 마감 내역</strong></h2></div>
                    <table id = "extralist" summary="업체명,세부내역,관세사,공급가액,금액  목록입니다" cellpadding="0" cellspacing="0" style="width:1100px;">
                    ...
                    <tr>
                        ...
                        <th rowspan ="2" scope="row"  nowrap="nowrap">업체</th>
                    ...
                    <tr>    
                        ...
                        <th scope="col" nowrap="nowrap"  class='cellr' class="endth">Total</th>
                    </tr>
                    </thead>
                    ...
                    <!-- loop 시작 -->                                
					  <tr class='<c:out value="${result.getExtra_style()}" default="normaltr"/>'>
			    		<td class='cellc' nowrap="nowrap"><c:out value="${result.getExtra_custom()}"  default=""/></td>
			    		...
			    		<td class='cellr'><fmt:formatNumber value="${result.getExtra_price()}" pattern="#,###" /></td>
			    		<td class='cellr'><fmt:formatNumber value="${result.getExtra_tax()}" pattern="#,###" /></td>
			    		<td class='cellr  endtd'><fmt:formatNumber value="${result.getExtra_total()}" pattern="#,###" /></td>
			    	  </tr>
			    	  </c:forEach>		
			        </tbody>
	                </table>
