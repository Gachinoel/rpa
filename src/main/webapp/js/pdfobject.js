...
(function (root, factory) {
    ...
    embed = function(url, targetSelector, options){
        ...
        var id = (options.id && typeof options.id === "string") ? "id='" + options.id + "'" : "",
            ...
            fallbackHTML = "",
            pdfOpenFragment = "",
            fallbackHTML_default = "<p>This browser does not support inline PDFs. Please download the PDF to view it: <a href='https://get.adobe.com/kr/reader/' target='_blank'>Download PDF Viewer</a></p>";
