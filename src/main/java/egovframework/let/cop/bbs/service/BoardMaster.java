...
public class BoardMaster implements Serializable {
	...
	/**  bl번호 vo에도 있음??? */
	private String checkContType = "";
	
	public String getCheckContType() {
		return checkContType;
	}
	public void setCheckContType(String checkContType) {
		this.checkContType = checkContType;
	}
	
	private List<String> nameVOList;
	
	public List<String> getNameVOList() {
	  return nameVOList;
	 }
	 
	 public void setNameVOList(List<String> nameVOList) {
	...
	public void setSearchKeyword(String searchKeyword) {
		...
		this.searchKeyword = sb.toString();
