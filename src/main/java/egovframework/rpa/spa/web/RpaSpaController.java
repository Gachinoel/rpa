...
package egovframework.rpa.spa.web;
...
import egovframework.rpa.spa.service.RpaSpaService;
import egovframework.rpa.util.service.RpaUtilService;

@Controller
public class RpaSpaController {
	...
	/** EgovMessageSource */
	@Resource(name="rpaSpaService")
	RpaSpaService rpaSpaService;
